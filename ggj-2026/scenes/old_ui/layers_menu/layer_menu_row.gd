...
var mask: OldMask
var box_hovered = load("res://scenes/old_ui/layers_menu/layer_menu_row_box_hovered.tres")
var box_normal = load("res://scenes/old_ui/layers_menu/layer_menu_row_box.tres")
...
func add_mask(new_mask: OldMask) -> void:
...
## è stata rilasciata
func _on_mask_dragged(value: bool, dragged_mask: OldMask):
	if value == false:
